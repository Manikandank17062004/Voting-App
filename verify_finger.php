...
$q1=mysqli_query($connect,"select * from vt_voter where id=$vid");
$r1=mysqli_fetch_array($q1);
mysqli_query($connect,"update vt_booth set voterid=$vid,status=1 where uname='$booth'");

mysqli_query($connect,"update vt_voter set finger_st=1 where id=$vid");

?>
<script language="javascript">
window.location.href="process.php?id=<?php echo $vid; ?>";
</script>
<?php
